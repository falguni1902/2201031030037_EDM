!function(e)
{
    ...
    {
        var s=e(this),i=s.data("bg-image");
        ...
        e(window).on("scroll",function(s)
        {
            ...
            e(".dropdown").on("show.bs.dropdown",function(){e(this).find(".dropdown-menu").first().stop(!0,!0).slideDown()}),e(".dropdown").on("hide.bs.dropdown",function(){e(this).find(".dropdown-menu").first().stop(!0,!0).slideUp()}),
            ...
            s.on("click",function(s){
                s.preventDefault();
                var i=e(this),t=i.attr("href");
                o.addClass("offcanvas-open"),
                e(t).addClass("offcanvas-open"),
                n.fadeIn(),i.parent().hasClass("mobile-menu-toggle")&&i.addClass("close")}),
